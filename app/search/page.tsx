  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="pt-[136px]">
        ...
        {/* Sticky Mobile Filters Header */}
        <div className="lg:hidden sticky top-[136px] z-40 bg-white border-b border-gray-200">
        ...
        <div className="flex">
          ...
          <main className={`w-full ${!loading && filteredProducts.length > 0 ? 'lg:pl-60' : ''}`}>
            <div className="max-w-7xl mx-auto px-0 sm:px-6 pb-16 pt-4">
              {loading ? (
